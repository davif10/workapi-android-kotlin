package com.davisilvaprojetos.workapi
...
class ProductAdapter(
    ...
    override fun onBindViewHolder(holder: ProductViewHolder, position: Int) {
        ...
        holder.productName.text = item.prPrice
    ...
    class ProductViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val productName: TextView = itemView.findViewById(R.id.prod_name)
        val productPrice: TextView = itemView.findViewById(R.id.prod_price)
    }
}